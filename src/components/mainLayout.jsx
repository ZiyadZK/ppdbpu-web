                    ...
                    <div className="px-5 py-5 bg-white">
                        {filteredPath === null ? (
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-5">
                                    <div className="space-y-1 hidden md:block text-end">
                                        <p className="text-sm">ziyad@gmail.com</p>
                                        <p className="text-xs opacity-60">Admin</p>
                                    </div>
                                    <button type="button" className="w-7 h-7 md:w-fit md:h-fit md:px-3 md:py-2 flex items-center justify-center text-zinc-600 border border-zinc-200 hover:border-zinc-500 rounded md:gap-2 hover:bg-zinc-100">
