...
export default function LoginPage() {
    ...
    return (
        <div className="w-full h-screen flex items-center justify-center bg-gradient-to-t from-teal-100">
            <div className="w-full h-full md:w-1/3 p-5 flex md:block justify-between flex-col md:rounded-2xl bg-white md:h-fit">
                ...
                <div className="flex flex-col items-center gap-2">
                    <button type="submit" className="w-full md:w-1/2 py-2 px-3 rounded-lg bg-teal-500 hover:bg-teal-400 focus:bg-teal-600 text-white flex items-center justify-center gap-3">
