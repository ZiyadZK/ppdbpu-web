        ...
        <div className="m-5 md:m-0">
          ...
          <div className="flex md:flex-row flex-col gap-5">
            ...
            <div className="p-5 bg-white rounded-2xl w-full md:w-1/2">
              ...
              <LineChart
                series={[
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_terdaftar_tkj']), label: 'TKJ', color: '#22c55e' },
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_terdaftar_dpib']), label: 'DPIB', color: '#92400e' },
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_terdaftar_tkr']), label: 'TKR', color: '#2563eb' },
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_terdaftar_tpm']), label: 'TPM', color: '#f97316' },
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_terdaftar_titl']), label: 'TITL', color: '#6b7280' },
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_terdaftar_geo']), label: 'GEO', color: '#e11d48' }
                ]}
          ...
          <div className="flex md:flex-row flex-col gap-5">
            <div className="p-5 bg-white rounded-2xl w-full md:w-1/2">
              ...
              <LineChart
                series={[
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_daftarUlang_jk_laki']), label: 'Laki - laki' },
                  { data: Object.keys(dataRekap).map(year => dataRekap[year]['total_daftarUlang_jk_perempuan']), label: 'Perempuan' },
                ]}
                xAxis={[{ scaleType: 'point', data: Object.keys(dataRekap).slice(0, 5) }]}
                height={300}
                className="w-full"
